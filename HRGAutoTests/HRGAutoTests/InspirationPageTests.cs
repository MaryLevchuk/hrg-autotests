...
{
    [TestFixture]
    public class InspirationPageTests : TestSettings
    {
        public InspirationPageTests()
            : base("chrome", "preprod")
        {
        ...
        {
            Filter.TurnOnFiltersByName("destinations", "seasons", "attractions");
        ...
        public string Options_AreAllowed_ToBeMarked(string filterName, params int[] states)
        {
            ...
            filter.MarkOptionsByOrderNumber(states);
            Thread.Sleep(500);
